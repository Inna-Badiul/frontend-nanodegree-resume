...
// did not use, instead inserted URL into HTMLonlineTitle
...
/**
 * @description Internationalizes name
 * @param {string} oldName
 * @returns {string} Internationalized version of oldName
 */
function inName(oldName) {
    var newName = oldName;

    var splits = newName.split(' ');
    splits[0] = splits[0].slice(0,1).toUpperCase() + splits[0].slice(1).toLowerCase();
